...
<head>
    ...
    /* Dark theme styles for COD Ready table */
    .table-responsive {
        margin-top: 10px;
...
.soft-edge-square {
    ...
    #orderDetailsModal .info-card { background:#f8f9fa; border-radius:.5rem; transition:all .3s ease; }
    #orderDetailsModal .info-card:hover { transform:translateY(-3px); box-shadow:0 4px 15px rgba(0,0,0,0.1); }
    #orderDetailsModal .section-pill { background:#dc3545; color:#fff; border-radius:999px; padding:.6rem 1rem; display:inline-flex; align-items:center; gap:.5rem; box-shadow:0 3px 6px rgba(0,0,0,.2); }
    #orderDetailsModal .section-pill i { font-size:1rem; }
    </style>
            ...
            <div class="modal-body" style="max-height: 75vh; overflow-y: auto;">
                ...
                <div class="customer-details mb-4">
                    <div class="d-flex justify-content-center align-items-center mb-4">
                        <div class="section-pill"><i class="fas fa-user"></i><span class="fw-bold">Customer Details</span></div>
                    </div>
                    <div class="row g-4 mb-3">
                        <div class="col-md-4">
                            <div class="text-center">
                                <div class="border rounded-3 shadow-sm p-3 bg-light">
                                    <img id="modalCustomerImage" src="" alt="Customer Image" class="img-fluid rounded-3" width="200" height="200">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-8">
                            <div class="row g-2">
                                <div class="col-12">
                                    <div class="info-card p-3 border">
                                ...
                                <div class="col-12">
                                    <div class="info-card p-3 border">
                                        ...
                                        <div class="fw-bold" id="modalShippingAddress"></div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="info-card p-3 border">
                                        <div class="text-muted small mb-1">Transaction Number</div>
                                        <div class="fw-bold" id="modalTransactionNumber"></div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="info-card p-3 border">
                    ...
                    <div class="card border-0 shadow-sm mb-3">
                        <div class="card-header bg-primary text-white">
                            <div class="d-flex align-items-center"><i class="fas fa-shopping-cart me-2"></i><h6 class="mb-0">Order Information</h6></div>
                        </div>
                        <div class="card-body">
                            <div class="row g-3">
                                <div class="col-md-4"><div class="info-card p-3 border"><div class="text-muted small mb-1">Total Price</div><div class="fw-bold text-success" id="modalTotalPrice"></div></div></div>
                                <div class="col-md-4"><div class="info-card p-3 border"><div class="text-muted small mb-1">Delivery Fee</div><div class="fw-bold text-warning" id="modalDeliveryFee"></div></div></div>
                                <div class="col-md-4"><div class="info-card p-3 border"><div class="text-muted small mb-1">Total with Delivery</div><div class="fw-bold text-primary" id="modalTotalWithDelivery"></div></div></div>
                                <div class="col-md-6"><div class="info-card p-3 border"><div class="text-muted small mb-1">Payment Method</div><div class="fw-bold text-capitalize" id="modalPaymentMethod"></div></div></div>
                                <div class="col-md-6"><div class="info-card p-3 border"><div class="text-muted small mb-1">Total Weight</div><div class="fw-bold" id="modalTotalWeight"></div></div></div>
                                <div class="col-md-6"><div class="info-card p-3 border"><div class="text-muted small mb-1">Delivery Method</div><div class="fw-bold text-capitalize" id="modalDeliveryMethod"></div></div></div>
                                <div class="col-md-6"><div class="info-card p-3 border"><div class="text-muted small mb-1">Home Description</div><div class="fw-bold" id="modalHomeDescription"></div></div></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="rider-details mb-4" id="riderDetailsSection" style="display: none;">
                    <div class="d-flex justify-content-center align-items-center mb-3">
                        <div class="section-pill"><i class="fas fa-motorcycle"></i><span class="fw-bold">Rider Details</span></div>
                    </div>
                    <div class="row g-3">
                        <div class="col-md-6"><div class="info-card p-3 border"><div class="text-muted small mb-1">Rider Name</div><div class="fw-bold" id="modalRiderName"></div></div></div>
                        <div class="col-md-6"><div class="info-card p-3 border"><div class="text-muted small mb-1">Rider Contact</div><div class="fw-bold" id="modalRiderContactInfo"></div></div></div>
                        <div class="col-md-6"><div class="info-card p-3 border"><div class="text-muted small mb-1">Motor Type</div><div class="fw-bold" id="modalMotorType"></div></div></div>
                        <div class="col-md-6"><div class="info-card p-3 border"><div class="text-muted small mb-1">Plate Number</div><div class="fw-bold" id="modalPlateNumber"></div></div></div>
                    </div>
                </div>
...
<div class="modal fade" id="receiptModal" tabindex="-1" aria-labelledby="receiptModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body" id="receiptContent" style="background-color: white; color: black; padding: 20px;">
   ...
   <script src="lib/tempusdominus/js/tempusdominus-bootstrap-4.min.js"></script>
    ...
    <script>
        ...
        $('#orderDetailsModal').on('show.bs.modal', function (event) {
            ...
            var totalPriceNum = parseFloat(totalPrice) || 0;
            var deliveryFeeNum = parseFloat(deliveryFee) || 0;
            var totalWithDeliveryNum = totalPriceNum + deliveryFeeNum;

            $('#modalTotalPrice').text('₱' + totalPriceNum.toFixed(2));
            $('#modalDeliveryFee').text('₱' + deliveryFeeNum.toFixed(2));
            $('#modalTotalWithDelivery').text('₱' + totalWithDeliveryNum.toFixed(2));
        ...
        $('#printReceiptBtn').on('click', function() {
            ...
            // Parse monetary values safely (removed free shipping logic)
            ...
            var receiptHTML = `
                ...
                <div class="receipt-container" style="position: relative; width: 100mm; height: 150mm; box-sizing: border-box; padding: 4mm; border: 1px solid #000; font-family: Arial, sans-serif; color: #000;">
                    ...
                    <div style="text-align: center; margin-bottom: 2mm; position: relative; z-index: 2;">
                    ...
                    <div class="section" style="margin-top: 1.5mm; border-top: 1px dashed #000; padding-top: 1.5mm; position: relative; z-index: 2;">
                        <div style="font-weight:700; font-size: 3.5mm; margin-bottom:0.8mm;">BUYER</div>
                        <div style="font-size: 3mm;">${customerName}</div>
                        <div style="font-size: 3mm;">${shippingAddress}</div>
                        <div style="font-size: 3mm;">Home Desc: ${homeDescription}</div>
                    </div>
                    <div class="section" style="margin-top: 1.5mm; border-top: 1px dashed #000; padding-top: 1.5mm; position: relative; z-index: 2;">
                        <div style="font-weight:700; font-size: 3.5mm; margin-bottom:0.8mm;">SELLER</div>
                        <div style="font-size: 3mm;">CJ PowerHouse</div>
                        <div style="font-size: 3mm;">Brgy: Sinayawan Purok 3, Fronting 3-Star Hardware, Valencia City, Bukidnon, 8709</div>
                    </div>
                    <div class="section" style="margin-top: 1.5mm; border-top: 1px dashed #000; padding-top: 1.5mm; position: relative; z-index: 2;">
                        <div style="display:flex; justify-content: space-between; font-size: 3mm;">
                    ...
                    <div class="section" style="margin-top: 1.5mm; border-top: 1px dashed #000; padding-top: 1.5mm; position: relative; z-index: 2;">
                        <div style="font-weight:700; font-size: 3.5mm; margin-bottom:0.8mm;">ORDER SUMMARY</div>
                        <div style="display:flex; justify-content: space-between; font-size: 3mm;">
                        ...
                        <div style="display:flex; justify-content: space-between; font-size: 3.5mm; font-weight:700; border-top: 1px solid #000; margin-top:0.8mm; padding-top:0.8mm;">
                            <span>Total</span><span>₱${totalAmount.toFixed(2)}</span>
                        </div>
                    </div>
                    ${deliveryMethod && deliveryMethod.toLowerCase() === 'staff' ? 
                        `<div class="section" style="margin-top: 1.5mm; border-top: 1px dashed #000; padding-top: 1.5mm; position: relative; z-index: 2;">
                            <div style="font-weight:700; font-size: 3.5mm; margin-bottom:0.8mm;">DELIVERY</div>
                            <div style="font-size: 3mm;">CJ PowerHouse Staff Delivery</div>
                            <div style="font-size: 3mm;">Staff delivery service</div>
                        </div>` :
                        `<div class="section" style="margin-top: 1.5mm; border-top: 1px dashed #000; padding-top: 1.5mm; position: relative; z-index: 2;">
                            <div style="font-weight:700; font-size: 3.5mm; margin-bottom:0.8mm;">RIDER</div>
                            <div style="font-size: 3mm;">${riderName} | ${riderContact}</div>
