...
$result = $conn->query($sql);
                                ...
                                if ($result->num_rows > 0) {
                                    ...
                                    echo '<tr><td colspan="8">No pending COD orders found.</td></tr>';
                                }
                                ?>
                            </tbody>
                        </table>
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title text-dark w-100 text-center" id="orderDetailsModalLabel">Customer
                                & Order Details</h5>
                                    ...
                                    <div class="d-flex flex-row align-items-start">
                                        ...
                                        <div class="customer-image me-3">
                                            <img id="modalCustomerImage" src="" alt="Customer Image"
                                                class="soft-edge-square" width="250" height="250">
                                        </div>
...
$(document).ready(function() {
    ...
    $('#orderDetailsModal').on('show.bs.modal', function(event) {
        ...
        var totalWithDelivery = parseFloat(button.data('total-with-delivery')) || (parseFloat(totalPrice) + deliveryFee);
        ...
        // Build fields like GCASH view: separate price, delivery, total
        var subtotalNum = parseFloat(totalPrice) || 0;
        var isFreeShipping = subtotalNum >= 1500;
        var computedDelivery = isFreeShipping ? 0 : (parseFloat(deliveryFee) || 0);
        var computedTotal = isFreeShipping ? subtotalNum : (parseFloat(totalWithDelivery) || (subtotalNum + computedDelivery));
    ...
    if (typeof(EventSource) !== "undefined") {
        ...
        source.onmessage = function(event) {
            ...
            if (data.new_orders === true) {
                console.log("New COD orders detected! Refreshing table...");
