        ...
        $('#printReceiptBtn').on('click', function() {
            ...
            var receiptHTML = `
                ...
                <div class="receipt-container" style="position: relative; width: 100mm; height: 150mm; box-sizing: border-box; padding: 4mm; border: 1px solid #000; font-family: Arial, sans-serif; color: #000;">
                    <div class="watermark" style="position:absolute; top:50%; left:50%; transform:translate(-50%,-50%) rotate(-20deg); font-size: 24mm; color: rgba(0,0,0,0.06); font-weight: 700; letter-spacing: 1mm; user-select: none;">${watermarkText}</div>
