...
// Function to output CSS styles for staff notifications
function outputStaffNotificationCSS() {
    echo '<style>
.notification-badge {
    position: absolute;
    top: -5px;
...
// Function to output JavaScript for staff notifications
function outputStaffNotificationJS() {
    echo '<script>
...
function showUserActivityNotification(staffName, role, status, activity = "login", imagePath = "", additionalData = {}) {
    ...
    // Add cooldown to prevent rapid-fire notifications
