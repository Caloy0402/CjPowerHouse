                    ...
                    <div class="menu-item" style="background-color:#fff; border:1px solid #eee;">
                        ...
                        <div style="text-align:right;">
                            <?php
                                ...
                                $isFree = ((float)$ro['total_price']) >= 1500;
                            ?>
                            <div style="font-size:12px; color:#6c757d;">Delivery Fee: <?= $isFree ? '<span style="color:#28a745; font-weight:700;">FREE</span>' : ('₱'.htmlspecialchars($fee)) ?></div>
