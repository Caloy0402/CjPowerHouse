...
// Query to get the total cost of buyout products
$totalCostQuery = "SELECT SUM(Price * Quantity) AS total_cost FROM boughtoutproducts";
...
$totalProductsQuery = "SELECT COUNT(product_id) AS total_products FROM boughtoutproducts";
    ...
    <div class="row g-4 justify-content-center"> 
        <div class="col-md-4">
            <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4 w-100">
                ...
                <div class="ms-3">
                    <p class="mb-2">Total Cost of Buy Out Products</p>
        ...
        <div class="col-md-4">
            <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4 w-100">
                ...
                <div class="ms-3">
                    <p class="mb-2">Pending Restock</p>
        ...
        <div class="col-md-4">
            <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4 w-100">
                ...
                <div class="ms-3">
                    <p class="mb-2">Buy Out Products</p>
                    <h6 class="mb-0"><?php echo $totalQuantity; ?></h6>
                </div>
            </div>
        </div>
    </div>
