...
$sql_recent_items = "SELECT DISTINCT p.ProductID, p.ProductName, p.Price, p.ImagePath
                     FROM orders o
    ...
    <div class="sale-banner-container">
        ...
        <div class="sale-banner active" style="#">
            ...
            <div class="sale-content">
                <h2>Order worth ₱1500</h2>
                <p></p>
                <p class="code">For Free Shipping</p>
            </div>
        ...
        <div class="profile-content">
            <div class="profile-info">
                <div class="profile-avatar">
                    <?php if (!empty($user['ImagePath'])): ?>
                        <img src="<?= $baseURL . $user['ImagePath'] ?>" alt="Profile">
                    <?php else: ?>
                        <img src="https://ui-avatars.com/api/?name=<?= urlencode($user['first_name'] . ' ' . $user['last_name']) ?>&background=4CAF50&color=fff" alt="Profile">
                    <?php endif; ?>
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (pinToggle) {
        pinToggle.addEventListener('change', function() {
            ...
            // If enabling PIN protection, proceed normally
            if (enabled) {
                fetch('pin_management.php', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
    ...
    document.addEventListener('DOMContentLoaded', function() {
        try {
            ...
            es.onerror = function() {
                ...
                // simple retry by refreshing after a short delay
