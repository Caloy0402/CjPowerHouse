...
<!---end of modal-->
   ...
   <script src="lib/tempusdominus/js/tempusdominus-bootstrap-4.min.js"></script>
    ...
    <script>
        ...
        // Print Receipt behavior (same as GCASH pages)
        $('#printReceiptBtn').on('click', function() {
            ...
            var totalPrice = $('#modalTotalPrice').text().replace('₱', '');
            var deliveryFee = $('#modalDeliveryFee').text().replace('₱', '');
            var totalWithDelivery = $('#modalTotalWithDelivery').text().replace('₱', '');
            var paymentMethod = $('#modalPaymentMethod').text();
            ...
            var receiptHTML = `
                <div class="receipt-container" style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
                    <div style="text-align: center; margin-bottom: 20px;">
                        <img src="/Motorshop/Image/logo.png" alt="CJ PowerHouse" style="max-height: 80px; margin-bottom: 10px;">
                        <h2 style="margin: 5px 0; color: #333;">INVOICE</h2>
                        <p style="margin: 0; color: #666;">Order #${transactionNumber}</p>
                    </div>
                    <div style="border: 1px solid #eee; border-radius: 5px; padding: 15px; margin-bottom: 20px;">
                        <div style="display: flex; justify-content: space-between; margin-bottom: 10px;"><span style="font-weight: bold;">Order Date:</span><span>${orderDate}</span></div>
                        <div style="display: flex; justify-content: space-between; margin-bottom: 10px;"><span style="font-weight: bold;">Payment Method:</span><span>${paymentMethod}</span></div>
                        <div style="display: flex; justify-content: space-between; margin-bottom: 10px;"><span style="font-weight: bold;">Total Weight:</span><span>${totalWeight} kg</span></div>
                        <div style="display: flex; justify-content: space-between;"><span style="font-weight: bold;">Delivery Method:</span><span>${deliveryMethod}</span></div>
                    </div>
                    <div style="border: 1px solid #eee; border-radius: 5px; padding: 15px; margin-bottom: 20px;">
                        <h3 style="margin-top: 0; color: #333; border-bottom: 1px solid #eee; padding-bottom: 5px;">Customer Information</h3>
                        <p style="margin: 5px 0;"><strong>Name:</strong> ${customerName}</p>
                        <p style="margin: 5px 0;"><strong>Shipping Address:</strong> ${shippingAddress}</p>
                        <p style="margin: 5px 0;"><strong>Home Description:</strong> ${homeDescription}</p>
                    </div>
                    <div style="border: 1px solid #eee; border-radius: 5px; padding: 15px; margin-bottom: 20px;">
                        <h3 style="margin-top: 0; color: #333; border-bottom: 1px solid #eee; padding-bottom: 5px;">Rider Information</h3>
                        <p style="margin: 5px 0;"><strong>Name:</strong> ${riderName}</p>
                        <p style="margin: 5px 0;"><strong>Contact:</strong> ${riderContact}</p>
                        <p style="margin: 5px 0;"><strong>Motor Type:</strong> ${motorType}</p>
                        <p style="margin: 5px 0;"><strong>Plate Number:</strong> ${plateNumber}</p>
                    </div>
                    <div style="border: 1px solid #eee; border-radius: 5px; padding: 15px; margin-bottom: 20px;">
                        <h3 style="margin-top: 0; color: #333; border-bottom: 1px solid #eee; padding-bottom: 5px;">Order Summary</h3>
                        <div style="display: flex; justify-content: space-between; margin-bottom: 10px;"><span style="font-weight: bold;">Subtotal:</span><span>₱${parseFloat(totalPrice || 0).toFixed(2)}</span></div>
                        <div style="display: flex; justify-content: space-between; margin-bottom: 10px;"><span style="font-weight: bold;">Delivery Fee:</span><span>${$('#modalDeliveryFee').text()}</span></div>
                        <div style="display: flex; justify-content: space-between; font-size: 1.2em; font-weight: bold; border-top: 1px solid #eee; padding-top: 10px;"><span>Total:</span><span>₱${parseFloat(totalWithDelivery || totalPrice).toFixed(2)}</span></div>
                    </div>
                    <div style="text-align: center; color: #666; font-size: 0.9em; margin-top: 30px;">
                        <p>Thank you for shopping with us!</p>
                        <p>CJ PowerHouse - Valencia City, Bukidnon</p>
